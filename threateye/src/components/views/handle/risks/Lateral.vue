  ...
  export default {
    ...
    methods: {
      ...
      get_list_source_top5() {
        this.$axios.get('/yiiapi/horizontalthreat/source-top5')
          .then((resp) => {
      ...
      get_list_threat_top5() {
        this.$axios.get('/yiiapi/horizontalthreat/threat-top5')
          .then((resp) => {
            let {status, data} = resp.data;
            if (status == 0) {
      ...
      get_list_threat() {
        ...
        this.$axios.get('/yiiapi/horizontalthreat/list',{
          params:{
      ...
      ok_state() {
        ...
        this.$axios.put('/yiiapi/horizontalthreat/do-alarm', {
          id: id_group,
      ...
      prev_task_handle_assign() {
        ...
        this.$axios.put('/yiiapi/horizontalthreat/distribution-workorder',
          {
      ...
      prev_task_handle_save() {
        ...
        this.$axios.post('/yiiapi/horizontalthreat/add-workorder',
          {
            name: this.task_params.name,
            priority:this.task_params.level,
            perator:[],
      ...
      get_table_works_list(){
        this.$axios.get('/yiiapi/horizontalthreat/workorder-list',{
          params:{
