<template>
  <div id="UserLogin">
    ...
    <el-form class="login-form" status-icon :rules="loginRules" ref="loginForm" :model="loginForm" label-width="0">
      ...
      <el-form-item prop="username">
        ...
        <el-input class="view-input"  @keyup.enter.native="handleLogin" v-model="loginForm.username" auto-complete="off" placeholder="请输入用户名">
          ...
          <div slot="prefix" class="d-split"></div>
        </el-input>
      </el-form-item>
      <!--密码-->
      ...
      <!--验证码模块-->
      <!--<div class="code_info">-->
      <div class="code_info" v-show="count >= 3">
        <el-form-item prop="code">
          ...
          <div class="code-list">
            ...
            <div class="code" @click="refreshCode">
              <s-identify :identifyCode="identifyCode" :contentHeight ="contentHeight"></s-identify>
            </div>
          </div>
        </el-form-item>
    ...
    <div class="forget_pass">
      <a href="javascript:false;" class="pass_a">忘记密码？</a>
    </div>
  </div>
</template>
