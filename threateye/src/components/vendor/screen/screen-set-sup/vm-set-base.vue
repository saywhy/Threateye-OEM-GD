    ...
    <el-form class="content"
      ...
      <div class="section">
        ...
        <div class="form-item">
          ...
          <el-form-item>
            <el-input v-model="baseInfo.ScreenName"
                      placeholder="请输入大屏名称"
      ...
      <div class="section">
        ...
        <div class="radio-list">
          <el-radio v-model="radio"
                    label="headquarters">默认位置</el-radio>
          <el-radio v-model="radio"
                    label="branch">分支详情</el-radio>
        </div>
        <div class="form-item">
          ...
          <div v-show="radio == 'branch'">
            <div class="net-item">
              ...
              <div class="item"
                ...
                <span class="name">
                  <span class="na1">分支名称：</span>
                  <span class="na2">{{item.branch}}</span>
                </span>
                <span class="address">
                  <span class="na1">所在城市：</span>
                  <span class="na2">{{item.location}}</span>
                </span>
              </div>
            </div>
          </div>
      ...
      <div class="btn-group">
        <el-button class="btn btn_cacel"
                   @click="click_screen_cancel();">取消</el-button>
        <el-button class="btn btn_ok"
                   @click="click_screen_ok();">保存</el-button>
      </div>
    </el-form>
  </div>
</template>
