  ...
  export default {
    ...
    methods: {
      ...
      get_list_source_top5() {
        this.$axios.get('/api/yiiapi/horizontalthreat/source-top5')
          .then((resp) => {
      ...
      get_list_threat_top5() {
        this.$axios.get('/api/yiiapi/horizontalthreat/threat-top5')
          .then((resp) => {
            let {status, data} = resp.data;
            if (status == 0) {
      ...
      get_list_threat() {
        ...
        this.$axios.get('/api/yiiapi/horizontalthreat/list',{
          params:{
      ...
      ok_state() {
        ...
        this.$axios.put('/api/yiiapi/horizontalthreat/do-alarm', {
          id: id_group,
      ...
      prev_task_handle_assign() {
        ...
        this.$axios.put('/api/yiiapi/horizontalthreat/distribution-workorder',
          {
      ...
      prev_task_handle_save() {
        ...
        this.$axios.post('/api/yiiapi/horizontalthreat/add-workorder',
          {
            name: this.task_params.name,
            priority:this.task_params.level,
            perator:this.task_params.new_operator,
      ...
      get_table_works_list(){
        this.$axios.get('/api/yiiapi/horizontalthreat/workorder-list',{
          params:{
